...
function Footer() {
  ...
  <div class="relative block h-32 lg:col-span-2 lg:h-full">
    <img src="https://img.freepik.com/free-vector/transport-flat-muscle-car-illustration_23-2149450022.jpg?semt=ais_hybrid&w=740&q=80" alt="ourLogo" className="absolute inset-0 h-full w-full object-cover rounded-full"/>
  </div>

  <div class="px-4 py-6 sm:px-6 lg:col-span-3 lg:px-8">
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          <ul class="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> 1on1 Call </a>
            </li>
